...
export default function OnboardingPage() {
  ...
  return <div className="mx-auto max-w-3xl space-y-6"><div><span className="badge">Step {step + 1} of 4</span><h1 className="mt-3 text-3xl font-semibold">Set up your skin profile</h1></div>
